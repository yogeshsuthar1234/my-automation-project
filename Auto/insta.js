...
// console.log('👁 Sending Instagram views...');
// try {
//     await page.click('a[href="/tools/send-instagram-view"]', { timeout: 10000 });

//     // Fill in the media URL of the Instagram post
//     await page.fill('input[name="mediaUrl"]', postLink);

//     // Fill in the number of views to send
//     await page.fill('input[name="adet"]', '49999');

//     // Click the submit button
//     await page.click('button.btn-success:has-text("Start Submission")');

//     await page.waitForTimeout(3000);
// } catch (error) {
//     console.log('❌ Instagram views failed:', error.message);
// }
